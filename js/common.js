...
var mac_address, user_name, password, server_info, user_info,
    api_host_url, panel_url="https://aboplayer.tv/ukdMGUtEgAPEreS",
...
var lock=0;
var samsung_version='1.0.0', lg_version='1.0.2';
var focus_colors=[], background_colors=[], epg_text_colors=[], playlist_succeed=true;
...
function assignColorCode(color, kind){
    ...
    if(kind==='focus'){
        cssText=
            '\
                #home-page .menu-item.active {background: '+color+' !important;}\
