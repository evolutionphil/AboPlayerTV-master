...
var vod_summary_page={
    ...
    init:function(prev_route){
        ...
        hideImg($('#vod-summary-page .vod-series-background-img'));
        $('#vod-summary-page .vod-series-background-img').attr('src','');
    ...
    HandleKey:function (e) {
        ...
        switch (e.keyCode) {
            ...
            case tvKey.ENTER:
                ...
                break;
            case tvKey.YELLOW:
                if(VodModel.favourite_ids.includes(current_movie.is_favourite))
                    VodModel.addRecentOrFavouriteMovie(current_movie, 'favourite');
                else
                    VodModel.removeRecentOrFavouriteMovie(current_movie.stream_id,"favourite");
                break;
